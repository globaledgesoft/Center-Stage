...
Routes.prototype.init = function() {
   ...
   routesApp.get('/getMovements',function(req,res){
       console.log('in getMoments api')
	   http.get('http://54.153.108.137:8654/getMoments',function(response){
   ...
   routesApp.post('/singMusic',function(req,res){
        ...
        startBluetooth.on('close', (code) => {
            ...
            const stopMotionDetection = spawn('python', [startBulbScript,"4 4 2"]);
        ...
        const startMotionDetection = spawn('python', [startBulbScript,"4 4 3"]);
